...
class CoachesControllerTest < ActionController::TestCase
  ...
  test "should create coach" do
    assert_difference('Coach.count') do
      post :create, coach: { is_active: @coach.is_active, league_id: @coach.league_id, name: @coach.name }
    end
  ...
  test "should update coach" do
    patch :update, id: @coach, coach: { is_active: @coach.is_active, league_id: @coach.league_id, name: @coach.name }
    assert_redirected_to coach_path(assigns(:coach))
  end
